...
class FirstFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val nameEditText2 = view.findViewById<TextInputEditText>(R.id.textInputTextKampus)
        val nameEditText3 = view.findViewById<TextInputEditText>(R.id.textInputTextProdi)
        ...
        nameEditText3.addTextChangedListener(
            object : TextWatcher {
                ...
                override fun onTextChanged(
                    ...
                    communicationViewModel!!.setProdi(charSequence.toString())
                }
