...
class SecondFragment : Fragment() {
    ...
    private var txtProdi: TextView? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?)
    {
        ...
        super.onViewCreated(view, savedInstanceState)
        txtProdi = view.findViewById(R.id.textViewProdi)
        communicationViewModel!!.prodi.observe(requireActivity(),
            Observer { s -> txtProdi!!.text = s })
    }
    companion object {
